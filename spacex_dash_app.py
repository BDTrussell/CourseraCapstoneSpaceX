...
sitelist=spacex_df['Launch Site'].unique().tolist()
sitelist.insert(0,'All Sites')




app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard by Brandy',
                                ...
                                dcc.Dropdown(
                                   id='site-dropdown',
                                   options=[
                                    {'label': i, 'value': i} for i in sitelist],
